    ...
    <>
      <div className={`header__nav ${scrolled ? "scrolled" : ""} ${isHidden ? "hide" : "show"}`}>
        <div className="header__nav-container">
          ...
          <div className={`header__nav-links ${isMobileMenuOpen ? "header__nav-links--mobile-open" : ""}`}>
            {navLinks.map((link) => (
              <Link
                key={link.to}
                to={link.to}
      ...
      {isMobileMenuOpen && <div className="header__nav-overlay" onClick={() => setIsMobileMenuOpen(false)} />}
